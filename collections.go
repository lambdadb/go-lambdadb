...
func newCollections(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Collections {
	return &Collections{
		rootSDK:          rootSDK,
...
func (s *Collections) List(ctx context.Context, opts ...operations.Option) (*operations.ListCollectionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/collections")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCollectionsResponseBody
...
func (s *Collections) Create(ctx context.Context, request operations.CreateCollectionRequest, opts ...operations.Option) (*operations.CreateCollectionResponse, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "409", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
	...
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.ResourceAlreadyExistsError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Collections) Delete(ctx context.Context, collectionName string, opts ...operations.Option) (*operations.DeleteCollectionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Collections) Get(ctx context.Context, collectionName string, opts ...operations.Option) (*operations.GetCollectionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetCollectionResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Collections) Update(ctx context.Context, collectionName string, body operations.UpdateCollectionRequestBody, opts ...operations.Option) (*operations.UpdateCollectionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateCollectionResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Collections) Query(ctx context.Context, collectionName string, body operations.QueryCollectionRequestBody, opts ...operations.Option) (*operations.QueryCollectionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/query", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.QueryCollectionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.QueryCollectionResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

...
func newDocs(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Docs {
	return &Docs{
		rootSDK:          rootSDK,
...
func (s *Docs) doListDocs(ctx context.Context, request any, method, path, operationID, requestBodyField string, opts ...operations.Option) (*operations.ListDocsResponse, error) {
	...
	var baseURL string
	if o.ServerURL == nil {
		baseURL = s.sdkConfiguration.GetServerDetailsURL()
	} else {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.ListDocsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListDocsResponseBody
	...
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.UnauthenticatedError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.ResourceNotFoundError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.TooManyRequestsError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Docs) Upsert(ctx context.Context, collectionName string, body operations.UpsertDocsRequestBody, opts ...operations.Option) (*operations.UpsertDocsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/docs/upsert", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UpsertDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Docs) GetBulkUpsertInfo(ctx context.Context, collectionName string, branch *string, opts ...operations.Option) (*operations.GetBulkUpsertDocsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/docs/bulk-upsert", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetBulkUpsertDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetBulkUpsertDocsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Docs) BulkUpsert(ctx context.Context, collectionName string, body operations.BulkUpsertDocsRequestBody, opts ...operations.Option) (*operations.BulkUpsertDocsResponse, error) {
	// Keep the SDK default for the optional completion Type. The server validates
	// the uploaded object's Content-Type header independently of this field.
	if body.Type == nil {
	...
	res := &operations.BulkUpsertDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Docs) Update(ctx context.Context, collectionName string, body operations.UpdateDocsRequestBody, opts ...operations.Option) (*operations.UpdateDocsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/docs/update", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UpdateDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Docs) Delete(ctx context.Context, collectionName string, body operations.DeleteDocsRequestBody, opts ...operations.Option) (*operations.DeleteDocsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/docs/delete", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeleteDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Docs) Fetch(ctx context.Context, collectionName string, body operations.FetchDocsRequestBody, opts ...operations.Option) (*operations.FetchDocsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/collections/{collectionName}/docs/fetch", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.FetchDocsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.FetchDocsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
